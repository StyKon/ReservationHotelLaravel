      ...
      <div class="container-fluid">
        <div class="header-body">
          <div class="row align-items-center py-4">
            ...
            <a href="{{ route('Ville.index') }}" class="btn btn-sm btn-neutral">Back to list</a>
          ...
          <div class="card-wrapper">
            ...
            <div class="card">
              ...
              <div class="card-body">
                ...
                <form class="needs-validation" novalidate  action="{{ route('Ville.store') }}" method="post">
                @csrf
                  <div class="form-group">
                    <label class="form-control-label" for="validationCustom01">Nom de la Ville</label>
                      <input type="text" class="form-control" name="Nom" id="validationCustom01" placeholder="Nom de Ville"  required>
                      <div class="invalid-feedback">
                        Please choose a Ville.
                      </div>
                  </div>

                  <button class="btn btn-primary" type="submit">Ajouter Ville</button>
                </form>
              </div>
            </div>
