        ...
        <div class="col">
          <div class="card-wrapper">
            ...
            <div class="card">
              ...
              <form class="needs-validation" novalidate  action="{{ route('Hotel.update',$hotel->Id_Hotel) }}" method="post">
                @csrf
                @method('PUT')
                  <div class="form-row">
                    <div class="col-md-6 mb-3">
                      <label class="form-control-label" for="validationCustom01">Name Hotel</label>
                      <input type="text" class="form-control" name="Nom" value="{{$hotel->Nom}}"  id="validationCustom01" placeholder="Nom Hotel"  required>
                    ...
                    <div class="col-md-6 mb-3">
                      ...
                      @if($ville->Id_Ville == $hotel->Id_Ville)
                    {
                        <option value="{{$ville->Id_Ville}}" selected>{{$ville->Nom}}</option>
                    }
                    @else{
                  ...
                  <div class="form-row">
                    ...
                    <div class="col-md-6 mb-3">
                      ...
                      @if($category->Id_Category == $hotel->Id_Category)
                    {
                        <option value="{{$category->Id_Category}}" selected>{{$category->Type}}</option>
