        ...
        <div class="col">
          <div class="card-wrapper">
            ...
            <div class="card">
              ...
              <form class="needs-validation" novalidate  action="{{ route('Promotion.update',$promotion->Id_Promotion) }}" method="post">
                @csrf
                @method('PUT')
                <div class="row input-daterange datepicker align-items-center">
                    <div class="col">
                      <div class="form-group">
                        ...
                        <input class="form-control" name="DateDeb" value="{{$promotion->DateDeb}}" placeholder="Start date" type="text" required>
                      </div>
                    </div>
                    <div class="col">
                      <div class="form-group">
                        <label class="form-control-label">End date</label>
                        <input class="form-control" name="DateFin" value="{{$promotion->DateFin}}" placeholder="End date" type="text" required>
                      </div>
                    </div>
                  </div>
                  <div class="col">
                      <div class="form-group">
                        ...
                        <input class="form-control" name="Remise" value="{{$promotion->Remise}}" placeholder="Remise" type="number" required>
                      </div>
                    </div>
                    <div class="form-group">
                    ...
                    @if($hotel->Id_Hotel == $promotion->Id_Hotel)
                    {
                  ...
                  <button class="btn btn-primary" type="submit">Update Discount</button>
                </form>
              </div>
            </div>
